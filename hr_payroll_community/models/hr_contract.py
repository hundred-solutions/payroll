...
class HrContract(models.Model):
    ...
    house_rent_allowance = fields.Monetary(string='HRA', tracking=True,
    ...
    internet_allowance = fields.Monetary(string="Internet Allowance",
                                      help="Internet/Mobile allowances")
    tax_deduction = fields.Monetary(string="Tax Deduction", help="Tax deduction at source")
